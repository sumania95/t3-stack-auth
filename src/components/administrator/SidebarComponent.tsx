  ...
  return (
    <div>
        <div className='w-56 flex flex-col border-r h-[calc(100vh-64px)] p-2 space-y-1'>
          ...
          <Link href={'/administrator/approve'} className='w-full hover:bg-gray-200 p-2 hover:cursor-pointer'>TRACKS PENDING</Link>
          ...
          <Link href={'/administrator/subscription'} className='w-full hover:bg-gray-200 p-2 hover:cursor-pointer'>SUBSCRIPTION</Link>
