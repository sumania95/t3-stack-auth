  ...
  return (
    <div>
        <div className='w-56 flex flex-col border-r h-[calc(100vh-64px)] p-2 space-y-1'>
          ...
          <Link href={'/user/administrator/subcription'} className='w-full hover:bg-gray-200 p-2 hover:cursor-pointer'>SUBSCRIPTION</Link>
          <Link href={'/user/administrator/users'} className='w-full hover:bg-gray-200 p-2 hover:cursor-pointer'>USERS</Link>
        </div>
    </div>
  )
}
